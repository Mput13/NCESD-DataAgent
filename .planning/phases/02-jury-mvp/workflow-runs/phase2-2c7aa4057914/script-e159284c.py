...
Run ID: phase2-2c7aa4057914
Source: world_bank / FP.CPI.TOTL.ZG
Generated: 2026-05-11T23:14:34Z

Usage:
    python script-e159284c.py
...
def main() -> None:
    ...
    source_card = {
        ...
        "dataset_id": "FP.CPI.TOTL.ZG",
        "resource_id": "FP.CPI.TOTL.ZG",
    }
    filters = {'geography': 'USA', 'countries': ['USA'], 'indicator': 'inflation rate', 'period': '2000-2023'}

    # Operations from extraction plan: ['filter_rows', 'join_indicators', 'coverage_preview']
