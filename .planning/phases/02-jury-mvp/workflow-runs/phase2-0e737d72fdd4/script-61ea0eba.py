...
Run ID: phase2-0e737d72fdd4
Source: fedstat / 55396
Generated: 2026-05-12T09:21:24Z

Usage:
    python script-61ea0eba.py
...
def main() -> None:
    ...
    filters = {'periods': ['2023'], 'geography': 'Russia', 'countries': ['Russia'], 'indicator': 'Inflation'}

    # Operations from extraction plan: ['coverage_preview', 'filter_rows', 'join_indicators', 'export_dataset']
