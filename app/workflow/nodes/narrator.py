...
def _build_response_live(
    ...
    *,
    ...
    system_prompt = (
        ...
        "1. СТИЛЬ: Официально-деловой, профессиональный аналитический язык. Избегай разговорных выражений.\n"
        "2. ЗАПРЕЩЕННЫЕ СЛОВА: Никогда не используй технический жаргон системы ('ok', 'gated', 'passed', 'workflow', 'node', 'artifact'). "
        "Пользователь должен видеть только результат анализа, а не процесс работы программы.\n"
        "3. ЦИФРЫ: Используй только данные из предоставленных records. Если данных нет — укажи на их отсутствие в источниках, не выдумывай значения.\n"
        "4. СТРУКТУРА: \n"
        "   - Начни с главного тезиса.\n"
        "   - Приведи конкретные цифры (самые свежие из records) и их динамику.\n"
        "   - Дай краткий контекст или пояснение методологии, если это важно.\n"
        "   - В конце предложи 2-3 направления для дальнейшего изучения.\n"
