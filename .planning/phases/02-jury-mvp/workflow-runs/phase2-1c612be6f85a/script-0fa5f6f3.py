...
Run ID: phase2-1c612be6f85a
Source: world_bank / NY.GDP.DEFL.KD.ZG.AD
Generated: 2026-05-11T23:08:30Z

Usage:
    python script-0fa5f6f3.py
...
def main() -> None:
    ...
    source_card = {
        ...
        "dataset_id": "NY.GDP.DEFL.KD.ZG.AD",
        "resource_id": "NY.GDP.DEFL.KD.ZG.AD",
    }
    filters = {'geography': 'USA', 'countries': ['USA'], 'indicator': 'GDP, inflation', 'period': '1999-2012'}
